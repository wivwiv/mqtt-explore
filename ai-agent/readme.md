...
用户每次洗完衣服都要手动放下晾衣架。经过无数次重复操作后，才会想到是否可以让这个过程自动化，然后通过复杂的软件配置来实现"洗衣机开门时自动降下晾衣架"的联动。

**AI 智能识别**

AI 通过观察用户行为模式，发现"打开洗衣机后放下晾衣架"这个高频场景。它会主动询问："我注意到您经常在洗完衣服后放下晾衣架，需要我帮您自动完成这个步骤吗？"
...
- 当你请家务机器人拿饮料时，它无需实地查看冰箱
- 因为冰箱可以直接告知机器人内部储存的饮料信息
- 机器人据此决定是否前往取饮料
